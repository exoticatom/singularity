...
> **Last updated: 2026-09-09** — Firmware v1.1.8 · Dashboard v1.5.7 · Copilot Rules updated

- 📌 [GPIO Map](hardware/gpio_map.md)
- 🔧 [Hardware Docs](hardware/README.md)
- ⚡ [ESPHome Config](esp32_singularity.yaml) — v1.1.8
- 📊 [Dashboard](singularity_dashboard.yaml) — v1.5.7
